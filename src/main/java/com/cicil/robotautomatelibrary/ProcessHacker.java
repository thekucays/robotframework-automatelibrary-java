...
public class ProcessHacker extends WelcomeExtender implements Welcomer{
	...
	public void adbShellCommandHack(String commandParam) {
		welcomeTheTester();
		String commandStr = "adb shell ";
		
		Process process = null;
		commandStr+=commandParam;
		
		System.out.print("Shell command is: "+commandStr+"\n");
        try {
            process = ProcessHelper.runTimeExec(commandStr);
        } catch (IOException e) {}
	...
	public static void main(String[] args) {
		...
		processHacker.adbShellCommandHack("service call statusbar 1");
	}
}
